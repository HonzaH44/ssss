...
//import { OptionsLineComponent } from "@babylonjs/inspector/components/actionTabs/lines/optionsLineComponent";
...
//const camera = new UniversalCamera("kamera", new Vector3(1,1,1), scene);
...
for (i = 0; i < 5; i++) {
  ...
  if (i === 2) {
    ...
    Mat.emissiveColor = new Color3(0, 8, 1, 0, 3);
    sphere.material = Mat;
  }
}
//světlo
